...
const textInput = assertElementById("text_input") as HTMLInputElement
const textOutput = assertElementById("text") as HTMLTextAreaElement
...
function getPreviousAndCurrentWords(words: string): [previous: string, current: string] {
